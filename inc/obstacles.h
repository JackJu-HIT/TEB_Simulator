...
/**
 * @class PointObstacle
 * @brief Implements a 2D point obstacle 实现2D点障碍
 */
...
/**
 * @class CircularObstacle 圆形障碍物
 * @brief Implements a 2D circular obstacle (point obstacle plus radius)　实现2D圆形障碍物（点障碍物加半径）
 */
